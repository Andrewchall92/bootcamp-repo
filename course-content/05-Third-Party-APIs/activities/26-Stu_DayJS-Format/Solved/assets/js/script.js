...
var gradDate = dayjs('2023-12-14').format('MMM D, YYYY');
$('#1a').text(gradDate);

// bonus: 
$("#1a").append("<br/>Days Remaining: " + dayjs('2023-12-14', 'MM/DD/YYYY').diff(dayjs(), 'days'))//how many days left from today
$("#1a").append("<br/>Days From Start to End: " + dayjs('2023-12-1', 'MM/DD/YYYY').diff(dayjs("09/18/2023", 'MM/DD/YYYY' ), 'days'));//days from start to end
$("#1a").append("<br/>Days Since start: " + dayjs().diff(dayjs('09/18/2023', 'MM/DD/YYYY'), 'days'));//days from start to end
